    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode  == FINE_LOCATION_REQUEST_CODE) {
            if (grantResults.length == 1 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(this, "User Denied to Give Location Permission", Toast.LENGTH_SHORT).show();
            ...
            locationClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
                ...
                public void onComplete(@NonNull Task<Location> task) {
                    ...
                    if (location != null){
                        ...
                        Toast.makeText(MapsActivity.this,"Somthing went worng!",Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
